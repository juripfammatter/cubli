...
extern atomic_t latest_state[4];              // Atomic array to hold the latest state estimates
extern atomic_t latest_reference[4];          // Atomic array to hold the latest reference values
