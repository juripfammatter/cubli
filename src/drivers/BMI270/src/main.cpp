...
int main(void)
{
	...
	*/
	...
	MatrixXf K(3,2);
	K<< 	0.70651668, -0.70652081,
		0.99958237,  0.00041399,
		0.00041691,  0.9995853;

	Matrix3f A;
	A << 	1.00000586,  0.01000003,  0.0,
		0.00117191,  1.00000586,  0.0,
		-0.00117191, -0.00000586,  1.0 ;

	MatrixXf C(2,3);
	C << 	0.00058595,  1.00000293,  0.0,
		-0.00058595, -0.00000293,  1.0;
	Matrix3f A_cl;
	A_cl = (A-K*C);
